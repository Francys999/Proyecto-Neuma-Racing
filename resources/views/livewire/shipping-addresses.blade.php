            ...
            @if ($newAddress)
                ...
                <div x-data="{
                    ...
                    <div class="grid grid-cols-2 gap-2">
                        ...
                        <div>
                            <button wire:click="store()" class="btn btn-red w-full">
                                Guardar
                            </button>
                        </div>
                    </div>
                ...
                @if ($editAddress->id)
                    ...
                    <div x-data="{
                        ...
                        <div class="grid grid-cols-2 gap-2">
                            ...
                            <div>
                                <button wire:click="update()" class="btn btn-red w-full">
                                    Actualizar
                                </button>
                            </div>
                        </div>
                    ...
                    @if ($addresses->count())
                        ...
                        <ul class="grid grid-cols-3 gap-4">
                            @foreach ($addresses as $address)
                                <li class="{{ $address->default ? 'bg-red-100' : 'bg-white' }} rounded-lg shadow"
                                    wire:key="addresses-{{ $address->id }}">
                                    <div class="p-4 flex items-center">
                                        <div>
                                            <i class="fa-solid fa-house text-xl text-red-500"></i>
                                        </div>
