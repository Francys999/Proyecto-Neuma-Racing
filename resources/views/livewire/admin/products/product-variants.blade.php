<div>
    <section class="rounded-lg border border-gray-100 bg-white shadow-lg">
        ...
        <div class="p-6">
                ...
                <div class="space-y-6">
                    ...
                    @foreach ($product->options as $option)
                        <div wire:key="product-option-{{ $option->id }}"
                            class="relative p-6 rounded-lg border border-gray-200">
            ...
            @else
                <div class="flex items-center p-4 text-sm text-blue-800 rounded-lg bg-blue-50 white:bg-gray-800 dark:text-blue-400"
                    role="alert">
            ...
            <ul class="mb-4 space-y-4">
                ...
                @foreach ($variant['features'] as $index => $feature)
                    <li wire:key="variant-feature-{{ $index }}"
                        ...
                        <div class="absolute -top-3 bg-dark px-4">
