<form wire:submit="store" class="space-y-6">
    <!-- Imagen -->
    <figure class="relative w-full h-[50vh] md:h-[70vh] lg:h-[900px]"> <!-- Altura ajustable según viewport -->
        <div class="absolute top-4 right-4 md:top-8 md:right-8">
            <label class="flex items-center px-4 py-2 rounded-lg bg-white cursor-pointer shadow-md hover:bg-gray-100 transition">
