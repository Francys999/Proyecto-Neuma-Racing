...
<head>
    ...
    <script src="https://kit.fontawesome.com/55a6c1b3db.js" crossorigin="anonymous"></script>
...
<body class="font-sans antialiased" x-data="{ sidebarOpen: false }" :class="{ 'overflow-y-hidden': sidebarOpen }">
    ...
    @if (session("swal"))
        <script>
            Swal.fire({!! json_encode(session("swal"), JSON_UNESCAPED_UNICODE | JSON_HEX_TAG | JSON_HEX_AMP | JSON_HEX_APOS | JSON_HEX_QUOT) !!});
        </script>
    @endif
